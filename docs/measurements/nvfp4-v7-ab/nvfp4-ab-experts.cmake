...
set(DS41RT_V41_NVFP4_TILE_M "auto" CACHE STRING "NVFP4 expert tile M (auto opts into the planner ladder; GPU qualification required)")
...
foreach(role IN LISTS DS41RT_V41_NVFP4_ROLES)
  ...
  add_custom_command(
    ...
    COMMAND "${CMAKE_COMMAND}" -E env ${DS41RT_SPARKINFER_PYTHON_ENV}
      ...
      --tile-m "${DS41RT_V41_NVFP4_TILE_M}" --output-shards 5
