...
# it runs ghcr.io/tpurtell/ds41rt-coordinator:v7 and
# ghcr.io/tpurtell/ds41rt-spark-expert:v7, so measurements describe what ships.
#
...
COORD_IMAGE=ghcr.io/tpurtell/ds41rt-coordinator:v7
SPARK_IMAGE=ghcr.io/tpurtell/ds41rt-spark-expert:v7
COORD_NAME=ds41rt-v7-published
