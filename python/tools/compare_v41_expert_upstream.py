...
def main():
    ...
    for rows in args.rows:
        ...
        for activation in (args.activation or ['silu_v41','silu']):
            ...
            with make_tp_moe_fp4_binding(a=x,experts=prepared[activation],topk_weights=routing,topk_ids=ids,quant_mode='w4a8_mx',swiglu_limit=10,output=output,fast_math=False) as binding:
                ...
                for cycle in range(3):
                    ...
                    allocated=torch.cuda.memory_allocated();graph.replay();torch.cuda.synchronize()
