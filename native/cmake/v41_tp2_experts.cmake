...
if(DS41RT_V41_TP2_COMPACT_EXPERIMENT)
  list(APPEND DS41RT_V41_TP2_COMPACT_ARGS --compact-max-capacity 16 --compact-live-rows 8)
endif()
foreach(rows IN ITEMS 1 16 80 256 1024 4096)
  ...
  list(APPEND DS41RT_V41_TP2_EXPERT_HEADERS "${stem}.h")
endforeach()
add_custom_command(
  OUTPUT "${DS41RT_V41_TP2_EXPERT_DIR}/v41_experts.json"
    "${DS41RT_V41_TP2_EXPERT_DIR}/v41_tp2_expert_variants.h"
    ${DS41RT_V41_TP2_EXPERT_OBJECTS} ${DS41RT_V41_TP2_EXPERT_HEADERS}
...
add_custom_target(ds41rt_v41_tp2_experts_export DEPENDS
  "${DS41RT_V41_TP2_EXPERT_DIR}/v41_tp2_expert_variants.h"
  "${DS41RT_V41_TP2_EXPERT_DIR}/v41_experts.json"
  ${DS41RT_V41_TP2_EXPERT_OBJECTS} ${DS41RT_V41_TP2_EXPERT_HEADERS})
add_dependencies(ds41rt_v41_tp2_experts_export ds41rt_verify_sparkinfer_source)
set_source_files_properties(${DS41RT_V41_TP2_EXPERT_OBJECTS} PROPERTIES
  EXTERNAL_OBJECT TRUE GENERATED TRUE)
list(APPEND DS41RT_NATIVE_SOURCES ${DS41RT_V41_TP2_EXPERT_OBJECTS} src/v41_tp2_experts.cc)
