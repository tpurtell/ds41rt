...
#include "v41_attention_heads32.h"
#include <atomic>
#include <mutex>
namespace {
ds41rt_v41_attention_heads32_Kernel_Module_t module{};
std::mutex initialization_mutex;
std::atomic<bool> initialized{false};
bool loaded[32]{};
}
extern "C" int32_t ds41rt_v41_attention_heads32_aot_initialize() {
  ...
  if (!module.module) {
    ...
    _mlir_ds41rt_v41_attention_heads32_cuda_init(args);
    if (result) return result;
  }
  void* args[] = {&library, &device, &result};
  _mlir_ds41rt_v41_attention_heads32_cuda_load_to_device(args);
  if (!result) {
    loaded[device] = true;
...
extern "C" int32_t ds41rt_v41_attention_heads32_aot_launch(const void* query, const void* descriptors,
  ...
  return cute_dsl_ds41rt_v41_attention_heads32_wrapper(&module,
